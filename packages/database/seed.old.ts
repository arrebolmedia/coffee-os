...
async function main() {
  ...
  const categories = [
    { name: 'Espresso', icon: '☕', color: '#8B4513' },
    { name: 'Filter Coffee', icon: '☕', color: '#D2691E' },
    { name: 'Cold Brew', icon: '🧊', color: '#4682B4' },
    { name: 'Pastries', icon: '🥐', color: '#DEB887' },
    { name: 'Sandwiches', icon: '🥪', color: '#F4A460' },
  ];
